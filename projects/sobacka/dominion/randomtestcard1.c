...
int main(){
	...
	for (int _ = 0; _ < 10000; _++){
		...
		int vPos; // vPos used to mark the village card position
		...
		int res;
	  	...
	  	if(testDeckCount >= 2){
	  		assertTrue(G.deckCount[currentPlayer] == testDeckCount - 2, __LINE__, failFlag);
	  	...
	  	// The number of buys should increase by two after playing this card
